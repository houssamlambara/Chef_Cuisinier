          ...
          <div class="flex items-center ms-3">
            <div>
              <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                ...
                <img class="w-full h-12 rounded-full" src="../6458b4217bf5b7e2b040cb46f9ae9dc4-805x1024.png" alt="user photo">
              </button>
            </div>
...
<div class="col-span-1 md:col-span-2 bg-white p-6 rounded-lg shadow-md overflow-x-auto mt-20 lg:ml-64 ">
    <h2 class="flex justify-center text-2xl font-bold mb-8 text-orange-500">Liste des Clients</h2>
    <div>
        ...
        <tbody>
          <?php
            ...
            <tr class="hover:bg-orange-500">
              ...
              <td class="border border-black px-4 py-2"><?php echo $row["email"] ?></td>
              <td class="border border-black px-4 py-2"><?php echo $row["phone"] ?></td>
            </tr>
          <?php endwhile; ?>
        </tbody>
      </table>
