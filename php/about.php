  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
    ...
    <main class="mx-auto px-4 py-24">
        <section class="max-w-6xl mx-auto">
            <h1 class="text-5xl font-bold text-center text-gray-900 mb-12 tracking-tight">Le Chef Alain Passard</h1>
            
            <div class="grid md:grid-cols-2 gap-12 items-center mb-16 bg-white rounded-xl shadow-lg p-8">
                <div class="space-y-6">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center bg-white rounded-xl shadow-lg p-8">
                <div>
...
<body class="bg-gray-50 text-gray-800">
    <!-- Previous navigation and main content remains the same -->
